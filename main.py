...
async def obhelp(ctx):
    ...
    Or you could use / commands. All of these commands still work.
    {ctx.author.mention}""")
...
async def obhelp(interaction):
    ...
    Or you could use prefix commands.(!, ?, -, =, ;) All of these commands still work.
    {interaction.user.mention}""")
